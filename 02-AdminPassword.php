...
<link rel="stylesheet" type="text/css" href="files/jquery-ui-1.css">
<link rel="stylesheet" type="text/css" href="bootstrap.css">
<link rel="stylesheet" type="text/css" href="font-awesome/css/font-awesome-min.css">
<script type="text/javascript" src="files/ui.js"></script>
...
<script src="files/jstz.js" type="text/javascript"></script>
...
<img src="files/images/logo.png"></img>
<div id="login-form"  >
<div class="box-inner" style="width:480px; height:300px;">

<center>
<font color="white" size="6" style="	text-shadow: 2px 2px #000000;">Please choose an admin password.</font>
</center>
   <div style="height:25px"></div>
<!--  <font color="white" size="4" style="	text-shadow: 2px 2px #000000;">Please moove the mouse randomly.</font>-->
<form name="form" method="post" action="03-ChooseDomain.php">

<input name="_token" value="6974ad151a13fa986ada5c1dbef2a03b" type="hidden">
<input name="_task" value="login" type="hidden"><input name="_action" value="login" type="hidden"><input name="_timezone" id="rcmlogintz" value="Europe/Berlin" type="hidden"><input name="_url" id="rcmloginurl" value="" type="hidden"><table><tbody>
...
<p class="formbuttons"><input id="rcmloginsubmit" class="button mainaction" value="Confirm" type="submit"></p>
