...
<center>
<font color="white" size="6" style="	text-shadow: 2px 2px #000000;">Choose your domain name</font>
</center>
   <div style="height:25px"></div>
<!--  <font color="white" size="4" style="	text-shadow: 2px 2px #000000;">Please moove the mouse randomly.</font>-->
<form name="form" method="post" action="04-GenerateSSLKey.php">
<input name="_token" value="6974ad151a13fa986ada5c1dbef2a03b" type="hidden">
<input name="_task" value="login" type="hidden"><input name="_action" value="login" type="hidden"><input name="_timezone" id="rcmlogintz" value="Europe/Berlin" type="hidden"><input name="_url" id="rcmloginurl" value="" type="hidden"><table><tbody><tr><td class="title"><label for="rcmloginuser">Domain name</label>
</td>
<td class="input"><input name="_user" id="rcmloginuser" required="required" size="40" autocapitalize="off" autocomplete="off" type="text"></td><td><font color="white" size="4">.omb.one</font></td>
</tr>
