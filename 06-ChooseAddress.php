...
<center>
<font color="white" size="6" style="	text-shadow: 2px 2px #000000;">Creating a new acount.</font>
</center>
   <div style="height:25px"></div>
<!--  <font color="white" size="4" style="	text-shadow: 2px 2px #000000;">Please moove the mouse randomly.</font>-->
<form name="form" method="post" action="07-GenerateGPG.php">
...
<td class="input"><input name="_user" id="rcmloginuser" required="required" size="40" autocapitalize="off" autocomplete="off" type="text"></td><td><font color="white" size="4">@<?php echo file_get_contents('dns'.$file, FILE_USE_INCLUDE_PATH) ?>.omb.one</font></td>
</tr>
...
<td class="input" colspan="2"><input name="_pass2" id="rcmloginpwd" required="required" size="40" autocapitalize="off" autocomplete="off" type="password"></td>
</tr>
</tbody>
</table>
