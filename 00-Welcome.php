...
<center>
<font color="white" size="6" style="	text-shadow: 2px 2px #000000;">Welcome to your Own-Mailbox.</br> In order to setup your own-mailbox press continue.</font>
<p class="formbuttons"><input id="rcmloginsubmit" class="button mainaction" value="Continue" onclick="window.location='01-tor.php';" type="submit"></p>
</center>
