<?php
exec("sudo /var/www/html/config/adduser.sh ".$_POST['_user']." ".$_POST['_pass']);
exec("cp ../index.html.roundcube ../index.html");
?>
<!DOCTYPE html>
...
var obj = 'window.location.replace("../roundcubemail-1.1.3/");';
setTimeout(obj,3000); 
...
<center>
<font color="white" size="6" style="	text-shadow: 2px 2px #000000;">Generating gpg key!</font>
</center>
